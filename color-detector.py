...
lower = np.array([20, 80, 20])
upper = np.array([35, 180, 255]) # (These ranges will detect Yellow)
    ...
    if len(mask_contours) != 0:
        for mask_contour in mask_contours:
            if cv2.contourArea(mask_contour) > 2000:
                ...
                cv2.rectangle(video, (x, y), (x + w, y + h), (50, 255, 50), 3) #drawing rectangle
                print("Objeto detectado")
            else:
                print("obj No detectado")
